...
<body>
  ...
  <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')" aria-label="hero">
    <div class="container">
      <div class="hero-content">
        ...
        <p class="hero-text">
          Welcome to Red Stream, a dedicated community-driven platform that aims to connect blood donors and recipients seamlessly.
  ...
  <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')" aria-label="hero">
    <div class="container">
      ...
      <figure class="hero-banner">
        ...
        <p style="font-size: larger;">Red Stream is started by the brainchild of a passionate group of engineering students polytechnic college - Govt. Polytechnic College Kaduthuruthy.
  ...
  <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')" aria-label="hero">
    <div class="container">
      <div class="hero-content">
        ...
        <p class="hero-text">
          At Red Stream, our vision is to create a centralized hub that connects blood donors and recipients in need. We envision a future where finding a suitable blood donor
  ...
  <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')" aria-label="hero">
    ...
    <div class="row" style="overflow: hidden; padding: 1cm;">
      <!-- First Column -->
      <div class="column">
        <h1 style="color: var(--oxford-blue-1); font-size: var(--fs-1);">Join the Red Stream Community</h1>
        <br>
        <p style="font-size: 17px;">
          We invite you to join our growing community of blood donors and recipients. By becoming a part of Red Stream,
      ...
      <div class="column">
        ...
        <br>
        <p style="font-size: 17px;">
          At Red Stream, we firmly believe that when individuals come together with a common purpose, remarkable things can happen. With your support and participation,
