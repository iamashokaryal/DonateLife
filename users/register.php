...
if (isset($_POST['register'])) {
  ...
  if ($count_email == 0 || $count_number == 0) {
    ...
    $query = "insert into donor_reg(full_name,mobile_number,email,password,blood_group,birth_date,gender,weight,state,district,zip_code,area,landmarks) 
    values('$name', '$number', '$email', '$hash', '$blood_group', '$dob', '$gender', '$weight', '$state', '$district', '$zip_code', '$area', '$landmarks')";
    $result = mysqli_query($conn, $query);
    if ($result) {
        ...
        <div class="container">
          <div class="form-container">
            ...
            <form action="#" method="POST">
              ...
              <div class="form-field">
                  <label for="gender">Users Type</label>
                  <select id="gender" name="gender" required>
                    <option value="" disabled selected>Select Type</option>
                    <option value="Male">Donor</option>
